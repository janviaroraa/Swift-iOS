...
class AViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        addViews()
        layoutConstraints()
        NotificationCenter.default.addObserver(self, selector: #selector(receiveData), name: Notification.Name("sendData"), object: nil)
    }
    ...
    @objc private func receiveData(notification: Notification) {
